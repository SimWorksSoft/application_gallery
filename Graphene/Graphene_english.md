...
Open the attached project and run the `Graphene_metamaterial.msf` script to obtain the transmittance corresponding to different graphene Fermi energy levels and numbers of layers (as shown in the figure below). The results closely match those presented in Figure 3(a) of Reference [^1]. The simulation results suggest that increasing the Fermi level of graphene leads to a blue shift in the resonant wavelength, and a higher number of graphene layers also results in an increased modulation intensity.
